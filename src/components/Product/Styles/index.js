...
const styles = EStyleSheet.create({
  ...
  veg: { position: 'absolute', height: 15, width: 15, end: 0, top: 0 },
  offtag: { position: 'absolute', top: 0, start: 0, backgroundColor: '#ffffff99', padding: 5, borderRadius: 5 },
  buttonarea: { height: 35, borderColor: '#006653', borderWidth: 1, borderRadius: 10, justifyContent: 'center', alignItems: 'center', width: '100%', 
    marginTop: 10,
  },
